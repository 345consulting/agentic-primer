...
from chapters import ch03_the_loop
...
def test_the_mock_refuses_to_cover_for_a_loop_that_ran_too_long() -> None:
    ...
    assert len(ch03_the_loop.MOCK_MODEL_REPLIES) == 3


def test_the_schema_the_lookup_and_the_prices_allow_the_same_items() -> None:
    permitted = set(get_args(ch03_the_loop.GroceryItem.__value__))
    assert permitted == set(ch03_the_loop.STOCK_ON_HAND) == set(ch03_the_loop.PRICE)
